...
int main(int argc, char** argv) {
  ...
  TFile* rootOutput = new TFile((TString)("/d0/scratch/kyhwang/WorkSpace/DRC/Aug2022TB/dev_230201/dual-readout_TB/analysis/230215_M2/IntRun" + std::to_string(runNum) + "_RunInfo.root"), "RECREATE");
  rootOutput->cd();
